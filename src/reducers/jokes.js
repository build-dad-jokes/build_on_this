import {
  ...
  FETCH_SAVEDJOKES_START,
  FETCH_SAVEDJOKES_SUCCESS,
  FETCH_SAVEDJOKES_FAILURE
} from "../actions";
...
export default function jokesReducer(state = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case FETCH_SAVEDJOKES_START:
      return {
        ...state,
        fetching: true
      };
    case FETCH_SAVEDJOKES_SUCCESS:
      return {
        ...state,
        fetching: false,
        savedJokes: action.payload
      };
    case FETCH_SAVEDJOKES_FAILURE:
      return {
        ...state,
        fetching: false,
        errors: action.payload
